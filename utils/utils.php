...
{ //Comprueba si una de las opciones del array que se le pasa es la que está (es para que en los artículos del blog tambiéns alga el blog como elemento ACTIVO)
    $activa = false;
